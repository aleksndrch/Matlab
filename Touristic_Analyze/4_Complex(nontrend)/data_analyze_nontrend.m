...
% %Linear(Base):
% xlswrite('out_data_nontrend.xlsx',label_tstat,1,'B2')
% xlswrite('out_data_nontrend.xlsx',outb_lin_tstat,1,'B3')
% xlswrite('out_data_nontrend.xlsx',label_fdwr,1,'H2')
% xlswrite('out_data_nontrend.xlsx',outb_lin_fdwr,1,'H3')
